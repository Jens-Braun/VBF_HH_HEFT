...
requirements = {
    ...
    "cython": {
        "command": "cython",
        "version_command": r"cython -V | grep -E -o '[0-9]+\.[0-9]+\.[0-9]*'"
    },
    "make": {
        "command": "make",
        "version_command": r"make --version | grep -E -o '[[:space:]][0-9]\.[0-9]'"
    },
    "cmake": {
        "command": "cmake",
        "version_command": r"cmake --version | grep -E -o '[0-9]+\.[0-9]+\.[0-9]*'"
    },
    "meson": {
        "command": "meson",
        "version_command": "meson --version",
        "min_version": "1.4.0"
    },
    "ocaml": {
        "command": "ocamlc",
        "version_command": "ocamlc --version",
        "min_version": "4.02.3"
    },
    "gfortran": {
        "command": "gfortran",
        "version_command": "gfortran -dumpfullversion",
        "min_version": "9.5.0"
    },
    "gcc": {
        "command": "gcc",
        "version_command": "gcc -dumpfullversion",
        "min_version": "9.5.0"
    },
    "g++": {
        "command": "g++",
        "version_command": "g++  -dumpfullversion",
        "min_version": "9.5.0"
    },
    "mpi": {
        "command": "mpirun",
    ...
    "mpifort": {
        "command": "mpifort",
        "version_command": "mpifort  -dumpfullversion",
        "min_version": "9.5.0"
    },
    "mpicc": {
        "command": "mpicc",
        "version_command": "mpicc  -dumpfullversion",
        "min_version": "9.5.0"
    },
    "mpic++": {
        "command": "mpic++",
        "version_command": "mpic++  -dumpfullversion",
        "min_version": "9.5.0"
    },
}
