...
# `vbf_hh_heft.py`
The utility script can be used to install the requirements and run a template for specific coupling values. Running the script requires the [`rich`](https://pypi.org/project/rich/) python library. See `./vbf_hh_heft.py --help` for details.