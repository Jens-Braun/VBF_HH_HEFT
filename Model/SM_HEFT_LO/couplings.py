...
GC_16 = Coupling(name = 'GC_16',
                 value = '(ee**2*complex(0,1))/(2.*sw**2)*c2V',
                 order = {'QED':2})
...
GC_33 = Coupling(name = 'GC_33',
                 value = '(-0.5*(cw*ee)/sw - (ee*sw)/(2.*cw))*cV',
                 order = {'QED':1})
...
GC_39 = Coupling(name = 'GC_39',
                 value = '(ee**2*complex(0,1) + (cw**2*ee**2*complex(0,1))/(2.*sw**2) + (ee**2*complex(0,1)*sw**2)/(2.*cw**2))*c2V',
                 order = {'QED':2})
...
GC_43 = Coupling(name = 'GC_43',
                 value = '-6*complex(0,1)*lam*vev*clambda',
                 order = {'QED':1})
...
GC_46 = Coupling(name = 'GC_46',
                 value = '(ee**2*complex(0,1)*vev)/(2.*sw**2)*cV',
                 order = {'QED':1})
...
GC_55 = Coupling(name = 'GC_55',
                 value = '(ee**2*complex(0,1)*vev + (cw**2*ee**2*complex(0,1)*vev)/(2.*sw**2) + (ee**2*complex(0,1)*sw**2*vev)/(2.*cw**2))*cV',
                 order = {'QED':1})
